...
import 'package:food_delivery_app/src/pages/otp.dart';
...
import 'package:food_delivery_app/src/pages/res_categories.dart';
import 'package:food_delivery_app/src/pages/reviews.dart';
...
import 'package:food_delivery_app/src/pages/web_page.dart';
import 'package:food_delivery_app/src/pages/yaadpay_payment.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/OTP':
        return MaterialPageRoute(builder: (_) => OTPWidget(routeArgument: args as RouteArgument));
      case '/ForgetPassword':
      ...
      case '/ResCategories':
        return MaterialPageRoute(builder: (_) => ResCategoriesWidget(routeArgument: args as RouteArgument));
      case '/Details':
        return MaterialPageRoute(
            builder: (_) =>
      ...
      case '/YaadPayCreditCard':
        return MaterialPageRoute(
            builder: (_) => OrderSuccessWidget(
                routeArgument: RouteArgument(param: 'YaadPay CreditCard')));
      case '/PayWithToken':
        return MaterialPageRoute(
            builder: (_) => OrderSuccessWidget(
                routeArgument: RouteArgument(param: 'Pay with Token')));
      case '/YaadPay':
        return MaterialPageRoute(
            builder: (_) =>
                YaadPayPaymentWidget(routeArgument: args as RouteArgument));
      case '/PayPal':
        return MaterialPageRoute(
            builder: (_) =>
      ...
      case '/Web':
        return MaterialPageRoute(builder: (_) => WebPageWidget(routeArgument: args as RouteArgument));
      default:
    }
  }
