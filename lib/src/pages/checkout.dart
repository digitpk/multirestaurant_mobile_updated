...
import 'package:food_delivery_app/src/elements/CreditCardsWidget.dart';
...
//                        Helper.getPrice(_con.taxAmount, context, style: Theme.of(context).textTheme.subhead)
                        Helper.getPrice(setting.value.defaultTax,context,style: Theme.of(context).textTheme.subhead)
                      ],
                    ),
                    Divider(height: 30),
                    Row(
